...
class CountrySelector extends StatefulWidget {
  ...
  final void Function(String?)? onCountrySelected; //return the selected country code
  const CountrySelector({Key? key, this.showDropDownList, this.showSearchField, this.onCountrySelected}) : super(key: key);
...
class _CountrySelectorState extends State<CountrySelector> {
  String? selectedCountryCode = countries.isNotEmpty ? countries.first['code'] : null;
          ...
          onChanged: () {
            setState(() {
              selectedCountryCode = countries
                  .firstWhere((country) =>
                  country['name']!.toLowerCase().contains(countryTextEditingController.text.toLowerCase()))
              ['code'];
